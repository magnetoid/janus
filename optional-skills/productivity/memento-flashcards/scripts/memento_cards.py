...
Data file: $JANUS_HOME/skills/productivity/memento-flashcards/data/cards.json
"""
...
_JANUS_HOME = Path(os.environ.get("JANUS_HOME", Path.home() / ".janus"))
DATA_DIR = _JANUS_HOME / "skills" / "productivity" / "memento-flashcards" / "data"
