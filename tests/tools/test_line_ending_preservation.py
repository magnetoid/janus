...
@pytest.fixture
def janus_home(monkeypatch, tmp_path):
    """Isolate JANUS_HOME so the tests don't pollute the real config.
...
class TestPatchCRLFPreservation:
    def test_patch_on_crlf_file_stays_pure_crlf(self, janus_home, tmp_path):
    ...
    def test_patch_on_lf_file_stays_lf(self, janus_home, tmp_path):
    ...
    def test_patch_multiline_replacement_on_crlf(self, janus_home, tmp_path):
...
class TestWriteFileCRLFPreservation:
    ...
    def test_new_file_written_as_is(self, janus_home, tmp_path):
    ...
    def test_overwrite_lf_file_stays_lf(self, janus_home, tmp_path):
