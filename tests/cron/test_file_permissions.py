...
class TestConfigFilePermissions(unittest.TestCase):
    ...
    def test_save_config_sets_0600(self):
        ...
        with patch("janus_cli.config.get_config_path", return_value=config_path), \
             patch("janus_cli.config.ensure_janus_home"):
    ...
    def test_ensure_janus_home_sets_0700(self):
        home = Path(self.tmpdir) / ".janus"
        with patch("janus_cli.config.get_janus_home", return_value=home):
