...
def test_load_transcript_returns_db_messages_when_no_jsonl(tmp_path, monkeypatch):
    ...
    ~/.janus/state.db. (DEFAULT_DB_PATH is a module-level constant computed
    at janus_state import time, before pytest's JANUS_HOME monkeypatch
    fires — the autouse fixture's JANUS_HOME override doesn't help here.)
    """
    import janus_state
