...
class TestGetProxyUrl:
    ...
    def test_returns_none_when_not_configured(self, monkeypatch):
        ...
        runner = _make_runner()
        with patch("gateway.runner._load_gateway_config", return_value={}):
    ...
    def test_reads_from_config_yaml(self, monkeypatch):
        ...
        with patch("gateway.runner._load_gateway_config", return_value=cfg):
...
class TestRunAgentViaProxy:
    ...
    async def test_builds_correct_request(self, monkeypatch):
        ...
        assert session.captured_headers["X-Janus-Session-Id"] == "session-abc"
