...
def worker_loop(worker_id: int, janus_home: str, result_file: str) -> None:
...
def reclaimer_loop(janus_home: str, result_file: str) -> None:
...
def main():
    home = tempfile.mkdtemp(prefix="janus_mixed_stress_")
    print(f"JANUS_HOME = {home}")
