...
The unit tests in tests/janus_cli/test_service_manager.py exercise the
...
docstring. ``/run/service`` is chowned janus-writable by the
...
_REGISTER_SCRIPT = """
import sys
sys.path.insert(0, "/opt/janus")
from janus_cli.service_manager import S6ServiceManager
