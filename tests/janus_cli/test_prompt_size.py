"""Tests for the ``janus prompt-size`` diagnostic (issue #34667)."""

import json

import pytest

from janus_cli.prompt_size import (
    _SKILLS_BLOCK_RE,
...
def _seed_skill(janus_home, name, description):
    skill_dir = janus_home / "skills" / "demo" / name
