"""Tests for the interactive session browser (`janus sessions browse`).
...
from janus_cli.main import _session_browse_picker
...
class TestSessionBrowseArgparse:
    ...
    def test_browse_subcommand_exists(self):
        """janus sessions browse should be parseable."""
