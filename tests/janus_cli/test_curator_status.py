"""Tests for `janus curator status` output.
...
def test_status_uses_last_activity_not_only_last_used(monkeypatch, capsys):
    ...
    import janus_cli.curator as curator_cli
...
def curator_status_env(tmp_path, monkeypatch):
    """Isolated JANUS_HOME with real agent-created skills on disk."""
    home = tmp_path / ".janus"
    skills = home / "skills"
    ...
    from janus_cli import curator as curator_cli
