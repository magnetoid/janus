...
The main() function in janus_cli/main.py sets subparsers.required=True
...
If the subcommand token is consumed as a flag value (e.g. `janus -c model`
...
def _build_parser():
    """Build a minimal replica of the janus top-level parser."""
