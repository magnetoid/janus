"""Tests for the specifier module + `janus kanban specify` CLI surface.
...
from janus_cli import kanban as kanban_cli
...
def _run_cli(*argv: str) -> int:
    """Invoke the `janus kanban …` argparse surface directly."""
