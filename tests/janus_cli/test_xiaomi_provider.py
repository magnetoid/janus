...
class TestXiaomiNormalization:
    ...
    def test_vendor_prefix_mapping(self):
        from janus_cli.model_normalize import _VENDOR_PREFIXES
...
class TestXiaomiProvidersModule:
    ...
    def test_overlay_exists(self):
        ...
        assert "xiaomi" in JANUS_OVERLAYS
        overlay = JANUS_OVERLAYS["xiaomi"]
...
class TestXiaomiDoctor:
    """Verify janus doctor recognizes Xiaomi env vars."""
