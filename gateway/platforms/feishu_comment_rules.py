...
Config: ~/.janus/feishu_comment_rules.json (mtime-cached, hot-reload).
Pairing store: ~/.janus/feishu_comment_pairing.json.
"""
...
# ---------------------------------------------------------------------------
#
# Uses the canonical ``get_janus_home()`` helper (JANUS_HOME-aware and
...
RULES_FILE = get_janus_home() / "feishu_comment_rules.json"
PAIRING_FILE = get_janus_home() / "feishu_comment_pairing.json"
