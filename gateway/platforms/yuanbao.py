...
try:
    ...
    _JANUS_VERSION = "0.0.0"

_APP_VERSION = _JANUS_VERSION
_BOT_VERSION = _JANUS_VERSION
_YUANBAO_INSTANCE_ID = str(JANUS_INSTANCE_ID)  # single source: yuanbao_proto.JANUS_INSTANCE_ID
