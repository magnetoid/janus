# nix/web.nix — Janus Web Dashboard (Vite/React) frontend build
{ pkgs, janusNpmLib, ... }:
let
  npm = janusNpmLib.mkNpmPassthru { folder = "web"; attr = "web"; pname = "janus-web"; };
...
pkgs.buildNpmPackage (npm // {
  ...
  buildPhase = ''
    ...
    # outDir in vite.config.ts points to ../janus_cli/web_dist for the
