 ...
 * `window.__JANUS_PLUGINS__.registerSlot(pluginName, slotName, Component)`
 ...
 *  - `header-left`      — injected before the Janus brand in the top bar
 ...
 *  `window.__JANUS_PLUGINS__.registerSlot(...)`.
 *
