/**
 * Janus Dashboard Plugin SDK — typed contract (SPIKE)
 * ====================================================
 *
 * This is the public type surface for ``window.__JANUS_PLUGIN_SDK__`` and
 * ``window.__JANUS_PLUGINS__``, the globals the dashboard host exposes to
 ...
 * window.__JANUS_PLUGIN_SDK__`` because:
 ...
 *
 * Versioning: bump ``JanusPluginSDK["sdkVersion"]`` (and the
 ...
 *   - Ship as a published ``@janus/dashboard-plugin-sdk`` types package, or
 ...
 * of calling ``fetch`` with a hand-read ``window.__JANUS_SESSION_TOKEN__``.
 */
...
// ---------------------------------------------------------------------------
// Registry surface (window.__JANUS_PLUGINS__)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// SDK surface (window.__JANUS_PLUGIN_SDK__)
// ---------------------------------------------------------------------------

export interface JanusPluginSDK {
...
declare global {
  interface Window {
    __JANUS_PLUGIN_SDK__?: JanusPluginSDK;
    __JANUS_PLUGINS__?: PluginRegistry;
  }
}
