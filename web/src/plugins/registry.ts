 ...
 *
 * Plugins call window.__JANUS_PLUGINS__.register(name, Component)
 ...
 * Exposed at runtime as ``window.__JANUS_PLUGIN_SDK__.sdkVersion`` so a
...
export function exposePluginSDK() {
  window.__JANUS_PLUGINS__ = {
    register: registerPlugin,
    registerSlot,
  };

  window.__JANUS_PLUGIN_SDK__ = {
    ...
    // window.__JANUS_SESSION_TOKEN__ directly.
    authedFetch,
