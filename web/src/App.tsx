...
const SIDEBAR_COLLAPSED_KEY = "janus-sidebar-collapsed";
          ...
          >
            ...
            >
              ...
              {sidebarNav.pluginItems.length > 0 && (
                <div
                  aria-labelledby="janus-sidebar-plugin-nav-heading"
                ...
                >
                  <span
                    ...
                    id="janus-sidebar-plugin-nav-heading"
                  >
...
function SidebarSystemActions({
  ...
  const items: SystemActionItem[] = [
    ...
    },
    {
      action: "update",
      icon: Download,
      label: t.status.updateJanus,
      runningLabel: t.status.updatingJanus,
      spin: false,
    },
  ];
