...
const STORAGE_KEY = "janus-dashboard-theme";
...
const FONT_STORAGE_KEY = "janus-dashboard-font";
 ...
 *  `_THEME_NAMED_ASSET_KEYS` in `janus_cli/web_server.py`. */
...
const CUSTOM_CSS_STYLE_ID = "janus-theme-custom-css";
...
function applyCustomCSS(css: string | undefined) {
  ...
  if (!el) {
    ...
    el.setAttribute("data-janus-theme-css", "true");
...
function injectFontStylesheet(url: string | undefined) {
  ...
  link.rel = "stylesheet";
  link.href = url;
  link.setAttribute("data-janus-theme-font", "true");
