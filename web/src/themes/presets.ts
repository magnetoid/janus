 ...
 * `_BUILTIN_DASHBOARD_THEMES` list in `janus_cli/web_server.py`.
 */
...
/**
 * Nous Blue — the inverted "light mode" Janus look, ported from the
 ...
 * nousnet-web's <body> is white; janus-agent's App root is `bg-black`,
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Janus Teal (Large)",
  description: "Janus Teal with bigger fonts and roomier spacing",
