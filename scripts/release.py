...
VERSION_FILE = REPO_ROOT / "janus_cli" / "__init__.py"
...
AUTHOR_MAP = {
    ...
    "jake@cloud-industry.com": "simpolism",
    ...
    "teknium@cloud-industry.com": "teknium1",
    ...
    "274096618+janus-agent-dhabibi@users.noreply.github.com": "dhabibi",
    ...
    "shannon@cloud-industry.com": "shannonsands",
    ...
    "janus@cloud-industry.com": "ImbaLabs",
    ...
    "ben@cloud-industry.com": "benbarclay",
    ...
    "emozilla@cloud-industry.com": "emozilla",
    ...
    "jonny@cloud-industry.com": "yoniebans",
    "jake@cloud-industry.com": "simpolism",
    ...
    "janus@example.com": "shellybotmoyer",  # PR #18915 (bot-committed)
    ...
    "sylw3st3rr@gmail.com": "Sylw3ster",  # salvage of #23252 (JANUS_KANBAN_BOARD restore)
    ...
    "58116817+TurgutKural@users.noreply.github.com": "TurgutKural",  # salvage of #23356 (JANUS_HOME inject)
    ...
    "sauravsejal40@gmail.com": "Saurav0989",  # PR #27071 (docs: janus-eval community link)
    ...
    "janusagent26@gmail.com": "janusagent26",  # PR #26438 (kimi model-name reasoning pad)
    "276067471+janusagent26@users.noreply.github.com": "janusagent26",
    ...
    "clement@cloud-industry.com": "lemassykoi",  # PR #27042 (model-switch probe keyless providers)
    ...
    "vigo@janus": "hawknewton",  # PR #26294 (bedrock boto3 lazy_deps)
    ...
    "kdkcfp@gmail.com": "slowtokki0409",  # PR #29025 (ignore local Janus runtime files)
    ...
    "2663402852@qq.com": "x1am1",  # PR #35098 (chown root-owned top-level JANUS_HOME state files)
...
def update_version_files(semver: str, calver_date: str):
    ...
    # Python package version. The desktop About panel reads the live Janus
...
def _update_acp_registry_versions(semver: str) -> None:
    ...
    if ACP_REGISTRY_MANIFEST.exists():
        ...
        if "package" in uvx:
            uvx["package"] = f"janus-agent[acp]=={semver}"
...
def parse_coauthors(body: str) -> list:
    ...
    _ignored_emails = {"noreply@anthropic.com", "noreply@github.com",
                       "cursoragent@cursor.com", "janus@cloud-industry.com"}
...
def generate_changelog(commits, tag_name, semver, repo_url="https://github.com/magnetoid/janus",
    ...
    lines.append(f"# Janus Agent v{semver} ({tag_name})")
    lines.append("")
    ...
    if first_release:
        ...
        lines.append("> for Janus Agent. See below for everything included in this initial release.")
        lines.append("")
...
def main():
    parser = argparse.ArgumentParser(description="Janus Agent Release Tool")
    ...
    print(f"{'='*60}")
    print(f"  Janus Agent Release Preview")
    print(f"{'='*60}")
    ...
    if args.publish:
        ...
        tag_result = git_result(
            "tag", "-a", tag_name, "-m",
            f"Janus Agent v{new_version} ({calver_date})\n\nWeekly release"
        )
        ...
        gh_cmd = [
            ...
            "--title", f"Janus Agent v{new_version} ({calver_date})",
        ...
        if result and result.returncode == 0:
            ...
            print(
                f"    gh release create {tag_name} --title 'Janus Agent v{new_version} ({calver_date})' "
