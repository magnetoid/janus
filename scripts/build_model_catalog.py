#!/usr/bin/env python3
"""Build the Janus Model Catalog — a centralized JSON manifest of curated models.
...
Janus CLI fetches at runtime. Publishing the catalog through the docs site
lets maintainers update model lists without shipping a Janus release.
...
# Ensure JANUS_HOME is set for imports that touch it at module level.
os.environ.setdefault("JANUS_HOME", os.path.join(os.path.expanduser("~"), ".janus"))

from janus_cli.models import OPENROUTER_MODELS, _PROVIDER_MODELS  # noqa: E402
...
def build_catalog() -> dict:
    return {
        ...
        "providers": {
            ...
            "nous": {
                "metadata": {
                    "display_name": "Cloud Industry Portal",
                    "note": (
