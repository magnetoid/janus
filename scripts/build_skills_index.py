#!/usr/bin/env python3
"""Build the Janus Skills Index — a centralized JSON catalog of all skills.
...
`janus skills search/install` can use it without hitting the GitHub API.
...
# Ensure JANUS_HOME is set (needed by tools/skills_hub.py imports)
...
def main():
    print("Building Janus Skills Index...", flush=True)
