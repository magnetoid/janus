...
DEFAULT_DATASETS = [
    "ImbaLabs/swe-terminus-agent-glm-kimi-minimax",
    "magnetoid/janus-megascience-sft1",
    "magnetoid/janus-Thinking-GLM-4.7-SFT2",
    "magnetoid/janus-Thinking-GLM-4.7-SFT1",
    "ImbaLabs/terminal-tasks-glm-hermes-agent"
]
...
def load_dataset_from_hf(dataset_name: str) -> List[Dict[str, Any]]:
    ...
    Args:
        dataset_name: HuggingFace dataset name (e.g., "ImbaLabs/dataset-name")
...
def main(
    ...
    print(f"   huggingface-cli upload ImbaLabs/{output_name} {final_output}")
