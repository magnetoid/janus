#!/usr/bin/env python3
"""
SWE Runner with Janus Trajectory Format

A runner that uses Janus-Agent's built-in execution environments
(local, docker, modal) and outputs trajectories in the Janus-Agent format
compatible with batch_runner.py and trajectory_compressor.py.

Features:
- Uses Janus-Agent's Docker, Modal, or Local environments for command execution
- Outputs trajectories in Janus format (from/value pairs with <tool_call>/<tool_response> XML)
...
# ============================================================================
# Terminal Tool Definition (matches Janus-Agent format)
# ============================================================================
...
def create_environment(
    ...
    **kwargs
    ...
    """
    Create an execution environment using Janus-Agent's built-in backends.
...
# ============================================================================
# Mini-SWE Runner with Janus Trajectory Format
# ============================================================================

class MiniSWERunner:
    """
    Agent runner that uses Janus-Agent's built-in execution environments
    and outputs trajectories in Janus-Agent format.
    """
    ...
    def _convert_to_janus_format(
        ...
        """
        Convert internal message format to Janus trajectory format.
...
Complete the user's task step by step."""
        ...
        # Convert to Janus trajectory format
        trajectory = self._convert_to_janus_format(messages, task, completed)
...
def main(
    ...
    """
    Run SWE tasks with Janus trajectory format output.
    ...
    """
    print("🚀 Mini-SWE Runner with Janus Trajectory Format")
    print("=" * 60)
