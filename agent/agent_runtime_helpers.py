...
def dump_api_request_debug(
    ...
    *,
    ...
    try:
        ...
        if env_var_enabled("JANUS_DUMP_REQUEST_STDOUT"):
...
def anthropic_prompt_cache_policy(
    ...
    *,
    ...
    # Cloud Industry Portal proxies to OpenRouter behind the scenes — identical
    # OpenAI-wire envelope cache_control semantics. Treat it as an
    # OpenRouter-equivalent endpoint for caching layout purposes.
    is_nous_portal = base_url_host_matches(eff_base_url, "cloud-industry.com")
    ...
    if (is_openrouter or is_nous_portal) and is_claude:
        return True, False
    # Cloud Industry Portal Qwen (e.g. qwen3.6-plus) takes the same envelope-layout
...
def switch_model(agent, new_model, new_provider, api_key='', base_url='', api_mode=''):
    ...
    if hasattr(agent, "context_compressor") and agent.context_compressor:
        ...
        try:
            from janus_cli.config import load_config, get_compatible_custom_providers
            _sm_cfg = load_config()
