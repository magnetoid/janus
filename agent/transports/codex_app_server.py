...
projection into Janus' display, approval bridging, transcript projection into
...
"codex_app_server"`. Janus' default tool dispatch is unchanged when this
...
class CodexAppServerClient:
    ...
    def __init__(
        ...
        if spawn_env.get("JANUS_KANBAN_TASK"):
            kanban_db = spawn_env.get("JANUS_KANBAN_DB")
            kanban_root = (
                ...
                if kanban_db
                    ...
                    "JANUS_KANBAN_ROOT",
                    os.path.join(
                        spawn_env.get("JANUS_HOME", os.path.expanduser("~/.janus")),
                        "kanban",
                    ),
                )
            )
    ...
    def initialize(
        self,
        client_name: str = "janus",
        client_title: str = "Janus Agent",
