...
``_check_spotify_available()`` — when the user has not run ``janus auth
spotify``, the tools remain registered (so they appear in ``janus
...
The Spotify auth flow (``janus auth spotify``), CLI plumbing, and docs
