...
required — uses aiohttp which is already a Janus dependency.
...
def interactive_setup() -> None:
    ...
    ``janus_cli/setup.py::_setup_mattermost`` function this migration
    removes.
    """
    ...
    print()
    print_info("📬 Home Channel: where Janus delivers cron job results and notifications.")
...
def register(ctx) -> None:
    ...
    ctx.register_platform(
        ...
        # janus_cli/setup.py::_setup_mattermost function.
