# Janus Achievements Performance Implementation Plan
...
- Snapshot persisted at `~/.janus/plugins/janus-achievements/scan_snapshot.json`.
...
Acceptance:
- Checkpoint persisted at `~/.janus/plugins/janus-achievements/scan_checkpoint.json`.
