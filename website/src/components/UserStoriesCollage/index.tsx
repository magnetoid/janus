  ...
  return (
    <div className={styles.wrap}>
      <div className={styles.hero}>
        ...
        <p>
          What the Janus Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone
          describes how they use Janus &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        Built something with Janus?{' '}
        <a
          href="https://github.com/magnetoid/janus/edit/main/website/src/data/userStories.json"
          target="_blank"
          rel="noopener noreferrer"
        >
        ...
        <a href="https://discord.gg/imbalabs" target="_blank" rel="noopener noreferrer">
          Cloud Industry Discord
        </a>{' '}
