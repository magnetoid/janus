...
description: "Try NVIDIA Nemotron 3 Ultra on Nous Portal — free June 4–18 — with day 0 support in Janus Agent"
---
...
[Download the Janus Desktop installer](https://hermes-agent.nousresearch.com/desktop) for macOS or Windows, then open it. On first launch it finishes setting itself up (usually under a minute).

### 2. Connect Nous Portal

When the app opens, you'll see a "Let's get you set up" screen. Click **Nous Portal** (marked **Recommended**). Your browser opens — create a [Nous Portal](https://portal.nousresearch.com) account (or sign in), choose the **Free** plan, and authorize Janus. The app connects automatically.
...
When prompted to connect your account to Janus Agent, click **Connect**. You'll see a confirmation once it's linked.
...
- **Don't see the model in the list?** Make sure you finished the Nous Portal connection and that you're on the **Free** plan. In the CLI, `janus portal info` confirms you're logged in and routing through Nous.
...
- **[Run Janus Agent with Nous Portal](/guides/run-janus-with-nous-portal)** — Full Portal walkthrough: models, Tool Gateway, and verification
