...
description: "The self-improving AI agent built by Imba Labs. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [Imba Labs](https://imbalabs.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
- **Built by model trainers** — Created by [Imba Labs](https://imbalabs.com), the lab behind Janus, Nomos, and Psyche. Works with [Janus Portal](https://portal.imbalabs.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Imba Labs](https://imbalabs.com) — the lab behind Janus, Nomos, and Psyche models
