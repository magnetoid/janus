...
slug: /
sidebar_position: 0
title: "Janus Agent Documentation"
description: "The self-improving AI agent built by Cloud Industry. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [Cloud Industry](https://cloud-industry.com). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
After installing, run `janus setup --portal` — one OAuth covers a model plus all four Tool Gateway tools (web search, image generation, TTS, browser). See [Cloud Industry Portal](/integrations/nous-portal).
:::
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Janus safely  |
| 🧭 **[Use MCP with Janus](/guides/use-mcp-with-janus)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Janus](/guides/use-voice-mode-with-janus)** | Hands-on setup and usage patterns for Janus voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Janus' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Janus                              |
...
- **Built by model trainers** — Created by [Cloud Industry](https://cloud-industry.com), the lab behind Janus, Nomos, and Psyche. Works with [Cloud Industry Portal](https://portal.cloud-industry.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Full web control** — Search, extract, browse, vision, image generation, TTS — one subscription via [Cloud Industry Portal](/integrations/nous-portal) bundles all of them
- **MCP support** — Connect to any MCP server for extended tool capabilities
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Cloud Industry](https://cloud-industry.com) — the lab behind Janus, Nomos, and Psyche models
