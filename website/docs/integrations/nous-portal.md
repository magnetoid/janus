...
If a model is genuinely missing, [open an issue](https://github.com/magnetoid/janus/issues) — we surface the Portal's catalog to Janus and gaps usually mean a routing config we can update.
