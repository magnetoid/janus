...
```bash
python3 -m pyfiglet "JANUS" -f slant | boxes -d stone
# Or without pyfiglet installed:
curl -s "https://asciified.thelicato.io/api/v2/ascii?text=JANUS&font=Slant" | boxes -d stone
```
