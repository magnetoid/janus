...
| | |
|---|---|
| Source | Optional — install with `janus skills install official/research/qmd` |
...
Janus Agent via the native MCP client. This is the preferred
...
Then configure Janus Agent to connect via HTTP:
