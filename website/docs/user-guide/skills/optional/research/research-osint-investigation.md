...
| | |
|---|---|
| Source | Optional — install with `janus skills install official/research/osint-investigation` |
| Path | `optional-skills/research/osint-investigation` |
| Version | `0.1.0` |
| Author | Janus Agent (adapted from ShinMegamiBoson/OpenPlanter, MIT) |
...
# $JANUS_OSINT_CACHE/icij/ (default: ~/.cache/janus-osint/icij/).
...
# Set JANUS_OSINT_UA=your-app/1.0 (your@email) to identify yourself
