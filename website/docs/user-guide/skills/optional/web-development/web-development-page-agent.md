...
- User wants **Janus itself to drive a browser** → use Janus' built-in browser tool (Browserbase / Camofox). page-agent is the *opposite* direction.
