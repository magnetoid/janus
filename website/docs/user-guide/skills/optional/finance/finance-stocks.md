...
| | |
|---|---|
| Source | Optional — install with `janus skills install official/finance/stocks` |
| Path | `optional-skills/finance/stocks` |
| Version | `0.1.0` |
| Author | Mibay (Mibayy), Janus Agent |
| License | MIT |
...
```
SCRIPT=~/.janus/skills/finance/stocks/scripts/stocks_client.py
...
```
python3 ~/.janus/skills/finance/stocks/scripts/stocks_client.py quote AAPL
```
