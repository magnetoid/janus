...
| | |
|---|---|
| Source | Optional — install with `janus skills install official/creative/pixel-art` |
...
```python
import sys
sys.path.insert(0, "/home/teknium/.janus/skills/creative/pixel-art/scripts")
...
```bash
cd /home/teknium/.janus/skills/creative/pixel-art/scripts
...
- ffmpeg on PATH (only needed for video — Janus installs package this)
