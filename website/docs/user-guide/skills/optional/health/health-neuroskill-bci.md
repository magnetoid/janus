...
| | |
|---|---|
| Source | Optional — install with `janus skills install official/health/neuroskill-bci` |
...
Connect Janus to a running [NeuroSkill](https://neuroskill.com/) instance to read
