...
| | |
|---|---|
| Source | Optional — install with `janus skills install official/blockchain/evm` |
| Path | `optional-skills/blockchain/evm` |
| Version | `1.0.0` |
| Author | Mibayy (@Mibayy), youssefea (@youssefea), ethernet8023 (@ethernet8023), Janus Agent |
| License | MIT |
...
Helper script path: `~/.janus/skills/blockchain/evm/scripts/evm_client.py`
...
```
SCRIPT=~/.janus/skills/blockchain/evm/scripts/evm_client.py
...
python3 ~/.janus/skills/blockchain/evm/scripts/evm_client.py stats
```
...
python3 ~/.janus/skills/blockchain/evm/scripts/evm_client.py ens vitalik.eth
```
