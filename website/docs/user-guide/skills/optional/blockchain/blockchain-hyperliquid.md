...
| | |
|---|---|
| Source | Optional — install with `janus skills install official/blockchain/hyperliquid` |
| Path | `optional-skills/blockchain/hyperliquid` |
| Version | `0.1.0` |
| Author | Hugo Sequier (Hugo-SEQUIER), Janus Agent |
| License | MIT |
...
The script reads `~/.janus/.env` for two optional defaults:
...
Helper script: `~/.janus/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py`
...
```bash
python3 ~/.janus/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py <command> [args]
```
...
optional when `HYPERLIQUID_USER_ADDRESS` is set in `~/.janus/.env`.
...
```bash
python3 ~/.janus/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py dexs

python3 ~/.janus/skills/blockchain/hyperliquid/scripts/hyperliquid_client.py \
