...
chat completions — use your Janus-managed provider subscription as their
...
| Use case | "Use Janus as a chat backend" | "Use my Portal sub from another app" |
...
This opens your browser for the Nous Portal OAuth flow. Janus stores
...
`janus_cli/proxy/adapters/<provider>.py` and registering it in
