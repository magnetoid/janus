...
const config: Config = {
  ...
  themeConfig: {
    image: 'img/janus-agent-banner.png',
    colorMode: {
      defaultMode: 'dark',
      ...
      links: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Cloud Industry', href: 'https://cloud-industry.com' },
          ],
        },
      ],
      copyright: `Built by <a href="https://cloud-industry.com">Cloud Industry</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
