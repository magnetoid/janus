...
Built for [Janus Agent](https://github.com/magnetoid/janus). Usable in any coding agent. Canonical source lives here; synced to [`magnetoid/janus/skills/creative/ascii-video`](https://github.com/magnetoid/janus/tree/main/skills/creative/ascii-video) via PR.
