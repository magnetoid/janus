...
import type { SessionInfo, UsageStats } from '@/types/janus'

type Updater<T> = T | ((current: T) => T)

const WORKSPACE_CWD_KEY = 'janus.desktop.workspace-cwd'
...
export const $connection = atom<JanusConnection | null>(null)
...
export const setConnection = (next: Updater<JanusConnection | null>) => updateAtom($connection, next)
