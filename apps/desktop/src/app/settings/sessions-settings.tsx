...
import { deleteSession, listSessions, setSessionArchived } from '@/janus'
...
import type { SessionInfo } from '@/types/janus'
...
// / Program Files), which buried any files Janus wrote there.
function DefaultProjectDirSetting() {
  ...
  useEffect(() => {
    ...
    // / Storybook / non-Electron context `window.janusDesktop` is
    ...
    const settings = window.janusDesktop?.settings
  ...
  return (
    <div className="mb-6">
      ...
      <ListRow
        ...
        description={dir || s.defaultsTo(fallback || '~/janus-projects')}
