import type { JanusConfigRecord, ToolsetInfo } from '@/types/janus'
...
export function getNested(obj: JanusConfigRecord, path: string): unknown {
  let cur: unknown = obj
...
export function setNested(obj: JanusConfigRecord, path: string, value: unknown): JanusConfigRecord {
...
function personalityOptions(config: JanusConfigRecord): string[] {
