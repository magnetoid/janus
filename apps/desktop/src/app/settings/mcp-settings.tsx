...
import { getJanusConfigRecord, type JanusGateway, saveJanusConfig } from '@/janus'
...
function getServers(config: JanusConfigRecord | null): McpServers {
...
export function McpSettings({ gateway, onConfigSaved }: McpSettingsProps) {
  ...
  const [config, setConfig] = useState<JanusConfigRecord | null>(null)
  ...
  const saveServer = async () => {
    ...
    try {
      ...
      await saveJanusConfig(nextConfig)
