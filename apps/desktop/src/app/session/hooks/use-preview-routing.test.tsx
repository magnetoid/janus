...
describe('usePreviewRouting', () => {
  beforeEach(() => {
    ...
    Object.defineProperty(window, 'janusDesktop', {
      configurable: true,
      value: {
  ...
  it('does not infer previews from assistant prose', async () => {
    ...
    expect(window.janusDesktop.normalizePreviewTarget).not.toHaveBeenCalled()
  })
  ...
  it('registers structured tool-result preview targets', async () => {
    ...
    expect(window.localStorage.getItem('janus.desktop.sessionPreviews.v1')).toContain('./dist/index.html')
  })
