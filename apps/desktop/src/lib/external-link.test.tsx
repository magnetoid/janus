...
const desktopWindow = window as unknown as { janusDesktop?: Window['janusDesktop'] }
const initialJanusDesktop = desktopWindow.janusDesktop

function installDesktopBridge(partial: Partial<Window['janusDesktop']> = {}) {
  desktopWindow.janusDesktop = {
    fetchLinkTitle: vi.fn().mockResolvedValue(''),
    openExternal: vi.fn().mockResolvedValue(undefined),
    ...partial
  } as unknown as Window['janusDesktop']
}
...
afterEach(() => {
  ...
  if (initialJanusDesktop) {
    desktopWindow.janusDesktop = initialJanusDesktop
  } else {
    delete desktopWindow.janusDesktop
  }
})
...
describe('external link helpers', () => {
  ...
  it('deduplicates in-flight title fetches and caches results', async () => {
    ...
    installDesktopBridge({ fetchLinkTitle: bridge as unknown as Window['janusDesktop']['fetchLinkTitle'] })
  ...
  it('opens links via the desktop bridge', () => {
    ...
    installDesktopBridge({ openExternal: openExternal as unknown as Window['janusDesktop']['openExternal'] })
