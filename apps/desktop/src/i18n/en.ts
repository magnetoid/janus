...
export const en: Translations = {
  ...
  boot: {
    ready: 'Janus Desktop is ready',
    desktopBootFailedWithMessage: message => `Desktop boot failed: ${message}`,
    steps: {
      connectingGateway: 'Connecting live desktop gateway',
      loadingSettings: 'Loading Janus settings',
      loadingSessions: 'Loading recent sessions',
      startingDesktopConnection: 'Starting desktop connection',
      startingJanusDesktop: 'Starting Janus Desktop…'
    },
    errors: {
      backgroundExited: 'Janus background process exited.',
      backgroundExitedDuringStartup: 'Janus background process exited during startup.',
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Janus backend is older than this desktop build and may not work correctly. Update to align them.',
    updateJanus: 'Update Janus',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Janus Desktop.',
  ...
  settings: {
    ...
    resetConfirm: 'Reset all settings to Janus defaults?',
    ...
    appearance: {
      ...
      colorModeDesc: 'Pick a fixed mode or let Janus follow your system setting.',
    ...
    about: {
      ...
      automaticUpdatesDesc:
        'Janus checks for updates automatically in the background and lets you know when one is ready.',
    ...
    config: {
      ...
      loading: 'Loading Janus configuration...',
    ...
    gateway: {
      ...
      intro:
        'Janus Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Janus backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      envOverrideDesc:
        'Unset JANUS_DESKTOP_REMOTE_URL and JANUS_DESKTOP_REMOTE_TOKEN to use the saved setting below.',
      localTitle: 'Local gateway',
      localDesc: 'Start a private Janus backend on localhost. This is the default and works offline.',
      remoteTitle: 'Remote gateway',
      remoteDesc:
        'Connect this desktop shell to a remote Janus backend. Hosted gateways use OAuth or a username and password; self-hosted ones may use a session token.',
      remoteUrlTitle: 'Remote URL',
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /janus.',
      ...
      restartingMessage: 'Janus Desktop will reconnect using the saved settings.',
      savedMessage: 'Saved for the next restart.',
      connectedTo: (baseUrl, version) => `Connected to ${baseUrl}${version ? ` · Janus ${version}` : ''}`,
    ...
    providers: {
      ...
      intro:
        'Sign in with a subscription — no API key to copy. Janus runs the browser sign-in for you, right here in the app.',
      connected: 'Connected',
      collapse: 'Collapse',
    ...
    toolsets: {
      ...
      ready: 'Ready',
      nousIncluded: 'Included with a Nous subscription — sign in to Cloud Industry Portal to activate.',
  ...
  commandCenter: {
    ...
    nav: {
      ...
      settings: { title: 'Settings', detail: 'Configure Janus desktop' },
    ...
    janusActiveSessions: (version, count) => `Janus ${version} · Active sessions ${count}`,
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@janus:example.org' },
  ...
  profiles: {
    ...
    deleting: 'Deleting...',
    createDesc: 'Profiles are independent Janus environments: separate config, skills, and SOUL.md.',
    nameLabel: 'Name',
  ...
  cron: {
    ...
    newCron: 'New cron',
    emptyDescNew:
      'Schedule a prompt to run on a cron expression. Janus will run it and deliver results to the destination you pick.',
  ...
  composer: {
    ...
    placeholderStarting: 'Starting Janus...',
    placeholderReconnecting: 'Reconnecting to Janus…',
    ...
    attachUrlDesc: 'Janus will fetch the page and include it as context for this turn.',
  ...
  updates: {
    ...
    unsupportedMessage: 'This version of Janus can’t update itself from inside the app.',
    connectionRetry: 'Check your connection and try again.',
    latestBody: 'You’re running the latest version.',
    allSetTitle: 'You’re all set',
    availableTitle: 'New update available',
    availableBody: 'A new version of Janus is ready to install.',
    updateNow: 'Update now',
    maybeLater: 'Maybe later',
    moreChanges: count => `+ ${count} more change${count === 1 ? '' : 's'} included.`,
    manualTitle: 'Update from your terminal',
    manualBody: 'You installed Janus from the command line, so updates run there too. Paste this into your terminal:',
    manualPickedUp: 'Janus will pick up the new version next time you launch it.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
    applyingBody: 'The Janus updater will take over in its own window and reopen Janus when it’s done.',
    applyingClose: 'Janus will close to apply the update.',
  ...
  install: {
    ...
    oneTimeTitle: 'Janus needs a one-time install',
    ...
    settingUpTitle: 'Setting up Janus Agent',
    finishingTitle: 'Finishing up',
    failedDesc:
      'One of the install steps failed. On Windows, this can happen if another Janus CLI or desktop instance is running. Stop any running Janus instances, then retry. Check the details below or the desktop log for the full transcript.',
    activeDesc:
      'This is a one-time setup. The Janus installer is downloading dependencies and configuring your machine. Subsequent launches will skip this step.',
  ...
  onboarding: {
    headerTitle: "Let's get you setup with Janus Agent",
    headerDesc: 'Connect a model provider to start chatting. Most options take one click.',
    preparingInstall: 'Janus is finishing install. This usually takes under a minute on first run.',
    starting: 'Starting Janus…',
    ...
    recommended: 'Recommended',
    connected: 'Connected',
    featuredPitch: 'One subscription, 300+ frontier models — the recommended way to run Janus',
    ...
    apiKeyOptions: {
      ...
      local: {
        short: 'self-hosted',
        description: 'Point Janus at a local or self-hosted OpenAI-compatible endpoint (vLLM, llama.cpp, Ollama, etc).'
      }
    },
    ...
    flowSubtitles: {
      ...
      device_code: 'Opens a verification page in your browser — Janus connects automatically',
      loopback: 'Opens your browser to sign in — Janus connects automatically',
    ...
    authorizeThere: 'Authorize Janus there.',
    ...
    autoBrowser: provider =>
      `We opened ${provider} in your browser. Authorize Janus there and you'll be connected automatically — nothing to copy or paste.`,
  ...
  shell: {
    ...
    statusbar: {
      ...
      gatewayTitle: 'Janus inference gateway status',
      agents: 'Agents',
  ...
  preview: {
    ...
    largeBody: (label, size) => `${label} is ${size}. Janus will only show the first 512 KB.`,
    ...
    web: {
      ...
      tryAgain: 'Try again',
      restarting: 'Janus is restarting...',
      askRestart: 'Ask Janus to restart the server',
      lookingRestart: taskId => `Janus is looking for a preview server to restart (${taskId})`,
      restartingTitle: 'Restarting preview server',
      restartingMessage: 'Janus is working in the background. Watch the preview console for progress.',
      ...
      finishedRestarting: message => `Janus finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Janus could not restart the server.',
      stillWorking:
        'Janus is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Janus is loading a response',
      thinking: 'Thinking',
    ...
    approval: {
      gatewayDisconnected: 'Janus gateway is not connected',
      ...
      alwaysDescription: pattern =>
        `This adds the “${pattern}” pattern to your permanent allowlist (~/.janus/config.yaml). Janus won’t ask again for commands like this — in this session or any future one.`,
  ...
  prompts: {
    ...
    sudoDesc: 'Janus needs your sudo password to run a privileged command. It is sent only to your local agent.',
    sudoPlaceholder: 'sudo password',
    secretTitle: 'Secret required',
    secretDesc: 'Janus needs a credential to continue.',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Janus Desktop to use Save Image.',
    restartToSaveImages: 'Restart Janus Desktop to save images',
