...
cd apps/desktop
XCURSOR_SIZE=24 JANUS_DESKTOP_DEV_SERVER=http://127.0.0.1:5174 \
...
node apps/desktop/scripts/profile-typing.mjs \
  --chars=400 --cps=30 --out=/tmp/janus-typing
# → /tmp/janus-typing.cpuprofile  (open in Chrome DevTools Performance)
# → /tmp/janus-typing.before.heapsnapshot
# → /tmp/janus-typing.after.heapsnapshot
```
