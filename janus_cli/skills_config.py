"""
Skills configuration for Janus Agent.
`janus skills` enters this module.

Toggle individual skills or categories on/off, globally or per-platform.
Config stored in ~/.janus/config.yaml under:
...
from janus_cli.config import cfg_get, load_config, save_config
from janus_cli.colors import Colors, color
from janus_cli.platforms import PLATFORMS as _PLATFORMS
