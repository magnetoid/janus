...
Invoked by ``janus kanban decompose [task_id | --all]`` and the
...
_SYSTEM_PROMPT = """You are the Kanban decomposer for the Janus Agent board.
...
def _profile_author() -> str:
    """Mirror of ``janus_cli.kanban._profile_author``."""
    return (
