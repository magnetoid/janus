...
Usage:
    janus pairing list              # Show all pending + approved users
    janus pairing approve <platform> <code>  # Approve a pairing code
    janus pairing revoke <platform> <user_id> # Revoke user access
    janus pairing clear-pending     # Clear all expired/pending codes
"""

def pairing_command(args):
    """Handle janus pairing subcommands."""
    ...
    if action == "list":
        ...
        print("Usage: janus pairing {list|approve|revoke|clear-pending}")
        print("Run 'janus pairing --help' for details.")
...
def _cmd_approve(store, platform: str, code: str):
    ...
    if result:
        ...
        print(
            ...
            "~/.janus/platforms/pairing/_rate_limits.json\n".format(platform)
        )
    else:
        print(f"\n  Code '{code}' not found or expired for platform '{platform}'.")
        print("  Run 'janus pairing list' to see pending codes.\n")
