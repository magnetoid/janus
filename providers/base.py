...
def _profile_user_agent() -> str:
    """Return a ``janus-cli/<version>`` UA string, with a stable fallback.
    ...
    """
    try:
        from janus_cli import __version__ as _ver  # lazy: avoid layer cycle at import time
        return f"janus-cli/{_ver}"
    except Exception:
        return "janus-cli"
...
class ProviderProfile:
    ...
    def fetch_models(
        ...
        *,
        ...
        # janus-cli UA so the catalog endpoint is reachable.
