...
Trust levels:
  - builtin:   Ships with Janus. Never scanned, always trusted.
...
THREAT_PATTERNS = [
    ...
    (r'\$HOME/\.janus/\.env|\~/\.janus/\.env',
     "janus_env_access", "critical", "exfiltration",
     "directly references Janus secrets file"),
    ...
    (r'\.janus/config\.yaml|\.janus/SOUL\.md',
     "janus_config_mod", "critical", "persistence",
     "references Janus configuration files directly"),
...
# scan. `.skillignore` is the Janus-native name; `.clawhubignore` is honored
