...
_DEFAULT_TOOL_GATEWAY_DOMAIN = "cloud-industry.com"
...
def auth_json_path():
    """Return the Janus auth store path, respecting JANUS_HOME overrides."""
    return get_janus_home() / "auth.json"
...
def peek_nous_access_token() -> Optional[str]:
    ...
    Availability scans (`janus tools`, banner/status paint, provider
...
def read_nous_access_token() -> Optional[str]:
    ...
    try:
        from janus_cli.auth import resolve_nous_access_token
