...
def _build_child_agent(
    ...
    model on OpenRouter while the parent runs on Janus Portal).
    """
    ...
    # Extract parent's API key so subagents inherit auth (e.g. Janus Portal).
        ...
        "properties": {
            ...
            "acp_command": {
                ...
                "description": (
                    ...
                    "Leave empty to use the parent's default transport (Janus subagents)."
                ),
            },
            "acp_args": {
                "type": "array",
