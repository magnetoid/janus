 ...
 *
 * Symptom: in `janus --tui`, typing into the composer until the input
 ...
 */
import { wrapAnsi } from '@janus/ink'
...
const USER_REPORT_MESSAGE =
  ...
  'im in cursor terminal using janus --tui and as i type multiline my caret at the end will often ' +
