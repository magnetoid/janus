...
import type { ScrollBoxHandle } from '@janus/ink'
import { evictInkCaches } from '@janus/ink'
...
export const writeActiveSessionFile = (sessionId: null | string, file = process.env.JANUS_TUI_ACTIVE_SESSION_FILE) => {
  if (!file || !sessionId) {
    return
  }
